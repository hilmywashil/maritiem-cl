    ...
    <main class="main-content">
        <div class="content-wrapper">
            ...
            <div class="page-header">
                ...
                <p>Lengkapi informasi untuk ditampilkan di halaman E-Katalog publik</p>
            </div>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="form-label required">
                                Nama Perusahaan
                                <span class="info-badge">Otomatis dari profil</span>
                            </label>
                            <input 
                                type="text" 
                                name="company_name" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea 
                                name="description" 
                                class="form-textarea" 
                                placeholder="Ceritakan tentang perusahaan Anda, produk/layanan yang ditawarkan, keunggulan, dan nilai tambah untuk pelanggan..."
